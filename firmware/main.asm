...
.cpywordloop0:
	...
	add	r1
		...
		// flags 1, 6a
						// (a/p assign)
						// Destination is a register...
						// Destination is a variable with offset 0, 497
		// Real offset of type is 497, isauto 0
						// (prepobj r0)
 						// reg r1 - no need to prep
						// (obj to tmp) flags 1 type 101
						// matchobj comparing flags 1 with 1
...
l210: # 
	...
	stdec	r6
		...
		// flags 42, 4a
						// (a/p assign)
						// Destination is a register...
						// Destination is a variable with offset 0, 329
		// Real offset of type is 337, isauto 0
						// (prepobj r0)
 						// reg r1 - no need to prep
						// (obj to tmp) flags 42 type a
						// matchobj comparing flags 42 with 1
	...
	sub	r1
		...
		// flags 42, 4a
						// (a/p assign)
						// Destination is a register...
						// Destination is a variable with offset 0, 361
		// Real offset of type is 361, isauto 0
						// (prepobj r0)
 						// reg r3 - no need to prep
						// (obj to tmp) flags 42 type a
						// matchobj comparing flags 42 with 42
...
l217: # 
	...
	stdec	r6
		...
		// Real offset of type is 409, isauto 0
						// (prepobj r0)
 						// reg r1 - no need to prep
						// (obj to tmp) flags 42 type a
						// matchobj comparing flags 42 with 4a
...
l241: # 
	...
	stbinc	r2
		...
		// flags 1, 6a
						// (a/p assign)
						// Destination is a register...
						// Destination is a variable with offset 0, 561
		// Real offset of type is 561, isauto 0
						// (prepobj r0)
 						// reg r1 - no need to prep
...
l276: # 
						...
						//../DeMiSTify/firmware/main.c, line 815
						//call
						//pcreltotemp
...
l282: # 
						...
						//../DeMiSTify/firmware/main.c, line 834
		// Offsets 0, 0
		// Have am? no, no
		// flags 1, 4a
						// (a/p assign)
	...
	add	r7
						...
						//../DeMiSTify/firmware/main.c, line 840
						//call
						//pcreltotemp
	...
	add	r7
						...
						//../DeMiSTify/firmware/main.c, line 843
						//call
						//pcreltotemp
	...
	add	r7
						...
						//../DeMiSTify/firmware/main.c, line 831
						//pcreltotemp
	.lipcrel	l282
	add	r7
	ldinc	r6
...
_main:
	...
	st	r0
						...
						//../DeMiSTify/firmware/main.c, line 865
						//call
						//pcreltotemp
	...
	add	r7
						...
						//../DeMiSTify/firmware/main.c, line 866
						//call
						//pcreltotemp
	...
	add	r7
						...
						//../DeMiSTify/firmware/main.c, line 867
						//setreturn
						// (obj to r0) flags 1 type 3
						// const
	.liconst	0
